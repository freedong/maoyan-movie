<template>
	<div>
		<div class="search-wrap">
			<input id="inp" name="" v-model="query" @keyup.enter="submit()">
...
<script>
	export default {
		...
		methods: {
			...
			submit: function () {
				// 这个出来的地址 http://localhost:8080/serchResult/你好
				// const path = '/serchResult/' + this.query
				// this.$router.push({path:path})

				// 这个出来的地址 http://localhost:8080/serchResult?name=你好
