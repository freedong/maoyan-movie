...
import star from "./star/star"
	export default {
		...
		mounted: function () {
			const commentId = 'https://api.douban.com/v2/movie/subject/' + this.$route.params.id + '/comments?apikey=0b2bdeda43b5688921839c8ecb20399b&count=40&client=something&udid=dddddddddddddddddddddd'
			this.$http.jsonp(commentId).then(function(response){
				this.guodu = false
